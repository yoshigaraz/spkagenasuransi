    ...
    <div class="container-fluid">
        ...
        <div class="row">
                        ...
                        <table class="table" id="table">
                            ...
                            @foreach ($data->employe as $users)
                                <tr>
                                    ...
                                    <td>
                                        {{-- @dd($users) --}}
                                        <button id="button-edit" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#exampleModal" data-modal="{{$users}}">
                                            <i class="fas fa-pencil-alt"></i> Edit
                                        </button>
                                        <a href="{{route('deleteKaryawan', ['employe' => $users->id ])}}"
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Tambah Agen</h6>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('inputKaryawan') }}">
                            @csrf
                            <div class="form-group">
                                <label for="inputCode">Kode Agen</label>
...
@section('js')
    <script>
        ...
        $(document).on("click", "#button-edit", function () {
            ...
            $(".modal-body #inputCode").val(datas.code);
